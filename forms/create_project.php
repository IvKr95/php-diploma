    ...
    <div class="form-holder">
        <form action="" method="post">
            ...
            <div>
                <p>Язык оригинала:</p>
                <label for="radio1">
                    <input type="radio" id="radio1" name="initial-lang" value="russian" checked>
                    Русский
                </label>
                <label for="radio2">
            ...
            <div>
                ...
                <label for="english">
                    <input type="checkbox" id="english" name="target-lang" value="english" checked>
                    Английский
                </label>
                <label for="german">
            ...
            <div>
                <textarea name="text" cols="60" rows="50"></textarea>
            </div>
            <div>
            ...
            <div>
                <label for="deadline">
                    Крайний срок
                    <input type="date" id="deadline" name="deadline" placeholder="10/10/2019" required>
                </label>
            </div>
            <div>
